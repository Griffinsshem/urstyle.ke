  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      ...
      <div className="text-center mb-16">
        <h1 className="text-5xl font-extrabold bg-gradient-to-r from-red-600 to-orange-500 bg-clip-text text-transparent">
          Returns & Refunds
        </h1>
        <div className="w-28 h-1 bg-gradient-to-r from-red-600 to-orange-500 mx-auto mt-4 rounded-full"></div>
      ...
      <div className="space-y-10">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-200">
          ...
          <ol className="text-gray-600 list-decimal list-inside space-y-3 leading-relaxed">
